 ...
 * });
 */
export async function api<M extends HttpMethod>(
  url: string,
  method: M,
...
export const get = (url: GetPath, options?: RequestOptions) =>
  api(url, 'get', options);
...
export const put = <T = any>(
  ...
  body?: T,
  options?: RequestOptions,
) => api(url, 'put', { ...options, body });
export const del = (url: DelPath, options?: RequestOptions) =>
  api(url, 'delete', options);
export const open = (url: GetPath, options?: RequestOptions) =>
  api(url, 'open', options);

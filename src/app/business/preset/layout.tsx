...
function PresetList() {
    ...
    if (pager.pageCount === 0 && !pager.search) {
        return (
            <Empty>
                <EmptyHeader>
                ...
                <EmptyContent className="flex-row justify-center gap-2">
                    <PresetCreateButtons idSuffix="preset-empty" onSuccess={() => pager.refresh()}/>
                </EmptyContent>
    ...
    return (
        <div className="flex flex-col w-full">
            <div className="flex gap-2 flex-row-reverse p-2">
                <PresetCreateButtons idSuffix="preset-list" onSuccess={() => pager.refresh()}/>
            </div>
